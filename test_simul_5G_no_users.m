...
input_matrix = [Mt Mr tiers N_subcarriers rrm_type SNR_req PRB_per_MS];
...
for index = 1:1:MC_repeats
 disp(index);
 [Pt(1,index),Pt_central_cell(1,index),SINR_user(1,index),users(1,index),users_central_cell(1,index)] = simul_5g_no_users(input_matrix,H_final);
...
save results_Mt_2_Mr_2_4_PRB_per_MS_40_max_SNIR;